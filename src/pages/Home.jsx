...
const properties = [
  ...
  },
  {
    ...
    path: "/mmg-wayanad",
    bg: "bg-[url('/assets/wayanad_resort.png')] bg-cover bg-center",
  },
  {
    title: "MMG Resorts Kodaikanal",
    tagline: "Serenity above the clouds",
    path: "/mmg-kodaikanal",
    bg: "bg-[url('/assets/kodaikanal_resort.png')] bg-cover bg-center",
  },
];
        ...
        <div className="relative z-10 text-center px-6 mt-16 max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-7xl md:leading-tight font-display text-cream mb-6 tracking-wide drop-shadow-2xl">
              Where Luxury <br />
              <span className="text-gold italic">Meets Nature</span>
            </h1>
          </motion.div>
          ...
          >
            Navakam Hospitality — Curating extraordinary escapes across India's
      ...
      <section className="py-16 md:py-24 px-6 bg-[#0a0a0a] relative overflow-hidden">
        <ScrollReveal className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-muted text-lg lg:text-xl font-light leading-relaxed max-w-3xl mx-auto">
            ...
            strong expertise in civil engineering and construction in Cochin,
            Kerala, the brand stands as a premium lifestyle developer rooted in
            real estate, hospitality, and sustainable farming. We offer
            thoughtfully designed investments that combine luxury, nature, and
            long-term value.
          </p>
        </ScrollReveal>
      </section>
      ...
      <section className="pb-16 md:pb-32 px-6 bg-[#0a0a0a]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="p-6 md:p-10 bg-[#121212] border border-white/5 border-l-2 border-l-gold shadow-2xl"
          >
            <h3 className="text-3xl font-display text-gold mb-6">
              Our Mission
            </h3>
            <ol className="list-decimal list-outside ml-5 space-y-4 text-muted text-lg font-light leading-relaxed">
              ...
              <li className="pl-2">
                Integrate sustainability with modern living
              </li>
              <li className="pl-2">
                Ensure high-quality infrastructure and amenities
              </li>
                ...
                <NavLink to={prop.path}>
                  ...
                  >
                    ...
                    <div className="relative z-10 p-6 md:p-10 w-full">
                      ...
                      <p className="text-cream/90 uppercase tracking-widest text-sm mb-6 translate-y-4 group-hover:translate-y-0 transition-transform duration-500 delay-75">
                        {prop.tagline}
                      </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 bg-[#121212] border border-white/5 hover:border-gold/30 transition-colors duration-300">
              ...
              <h3 className="text-2xl font-display text-cream mb-4">
                Navakam Resorts & Wellness Centre
              </h3>
              <p className="text-muted leading-relaxed font-light">
                Eco-resort model with luxury villas, spice gardens, and
                agri-tourism
              </p>
            </div>
            <div className="p-8 bg-[#121212] border border-white/5 hover:border-gold/30 transition-colors duration-300">
      ...
      <section className="py-16 px-6 bg-charcoal border-b border-white/5">
        <ScrollReveal className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-10">
            <div className="flex items-center gap-2 px-6 py-3 bg-[#1a1a1a] rounded-full border border-white/10 text-cream">
              ...
              <span className="text-sm tracking-widest uppercase font-light">
                Ilaveezha Poonchira,Vagamon,Kerala
              </span>
            </div>
            <div className="flex items-center gap-2 px-6 py-3 bg-[#1a1a1a] rounded-full border border-white/10 text-cream">
              <MapPin size={18} className="text-gold" />
          ...
          <p className="text-xs text-muted/60 tracking-wider">
            Primary administrative operations based in Thrissur, Poothole.
        ...
        <ScrollReveal className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted text-lg max-w-2xl mx-auto font-light">
              Participate in India's most distinctive agri-luxury investment
              model. Choose a scheme that matches your vision.
            </p>
          </div>
          <InvestmentSchemes />
        </ScrollReveal>
