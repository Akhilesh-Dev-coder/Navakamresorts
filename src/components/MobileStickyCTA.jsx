    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
           ...
           className="fixed bottom-0 left-0 right-0 z-40 bg-charcoal/95 backdrop-blur-md border-t border-gold/20 md:hidden p-4 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]"
        >
          <div className="flex gap-4">
            <a 
              href="mailto:info@navakam.com" 
              className="flex-1 bg-gold text-charcoal py-3 rounded-sm font-display uppercase tracking-widest text-center text-sm font-medium active:scale-95 transition-transform"
            >
              Enquire Now
            </a>
            <a 
